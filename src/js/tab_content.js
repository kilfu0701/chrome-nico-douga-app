define(['constants', 'util', 'core', 'i18n'], function(C, util, core, i18n) {
    ...
    function TabContent(tab_control, tab, $existing_webview) {
        ...
        this.elems = {
            ...
            $button_new: this.$content.find('.button-new'),
    ...
    $.extend(TabContent.prototype, {
        _setup_webview: function($webview) {
            ...
            // add contextMenus
            this._webview.contextMenus.create({
                type: 'normal',
                id: 'id-1',
            ...
            this._webview.addEventListener('newwindow', function(e) {
                ...
                this.tab_control.openNewTab(function(tab){
        ...
        _setup_listeners: function() {
            this.elems.$button_new.click(function() {
                window.postMessage(JSON.stringify({id: 'newTab'}), "*");
            });
